...
const emendasURL = "https://portaldatransparencia.gov.br/download-de-dados/emendas-parlamentares/UNICO"

func (o *Orchestrator) ensureDatasetZIP(ctx context.Context, dstPath string, st *db.ImportState) (string, error) {
	...
	resp, err := o.client.Get(ctx, emendasURL)
	if err != nil {
		return "", err
	}
	...
	if string(head) != "PK\x03\x04" {
		return "", fmt.Errorf("resposta nao e um ZIP valido para emendas UNICO")
	}
